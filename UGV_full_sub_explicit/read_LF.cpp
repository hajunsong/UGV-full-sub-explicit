...
void UnmannedGroundVehicle::read_LF(suspension *sus) {
	sus->q1 = LF_in[0];
	sus->dq1 = LF_in[1];
	...
	sus->J1p[0][0] = LF_in[15]; sus->J1p[0][1] = LF_in[16]; sus->J1p[0][2] = LF_in[17];
	sus->J1p[1][0] = LF_in[18]; sus->J1p[1][1] = LF_in[19]; sus->J1p[1][2] = LF_in[20];
	sus->J1p[2][0] = LF_in[21]; sus->J1p[2][1] = LF_in[22]; sus->J1p[2][2] = LF_in[23];
