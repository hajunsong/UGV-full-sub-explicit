...
void UnmannedGroundVehicle::read_RM(suspension *sus) {
	sus->q1 = RM_in[0];
	sus->dq1 = RM_in[1];
	...
	sus->J1p[0][0] = RM_in[15]; sus->J1p[0][1] = RM_in[16]; sus->J1p[0][2] = RM_in[17];
	sus->J1p[1][0] = RM_in[18]; sus->J1p[1][1] = RM_in[19]; sus->J1p[1][2] = RM_in[20];
	sus->J1p[2][0] = RM_in[21]; sus->J1p[2][1] = RM_in[22]; sus->J1p[2][2] = RM_in[23];
