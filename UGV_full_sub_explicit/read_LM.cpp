...
void UnmannedGroundVehicle::read_LM(suspension *sus) {
	sus->q1 = LM_in[0];
	sus->dq1 = LM_in[1];
	...
	sus->J1p[0][0] = LM_in[15]; sus->J1p[0][1] = LM_in[16]; sus->J1p[0][2] = LM_in[17];
	sus->J1p[1][0] = LM_in[18]; sus->J1p[1][1] = LM_in[19]; sus->J1p[1][2] = LM_in[20];
	sus->J1p[2][0] = LM_in[21]; sus->J1p[2][1] = LM_in[22]; sus->J1p[2][2] = LM_in[23];
