...
void UnmannedGroundVehicle::read_RR(suspension *sus) {
	sus->q1 = RR_in[0];
	sus->dq1 = RR_in[1];
	...
	sus->J1p[0][0] = RR_in[15]; sus->J1p[0][1] = RR_in[16]; sus->J1p[0][2] = RR_in[17];
	sus->J1p[1][0] = RR_in[18]; sus->J1p[1][1] = RR_in[19]; sus->J1p[1][2] = RR_in[20];
	sus->J1p[2][0] = RR_in[21]; sus->J1p[2][1] = RR_in[22]; sus->J1p[2][2] = RR_in[23];
