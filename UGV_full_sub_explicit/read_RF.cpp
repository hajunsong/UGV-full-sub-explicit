...
void UnmannedGroundVehicle::read_RF(suspension *sus) {
	sus->q1 = RF_in[0];
	sus->dq1 = RF_in[1];
	...
	sus->J1p[0][0] = RF_in[15]; sus->J1p[0][1] = RF_in[16]; sus->J1p[0][2] = RF_in[17];
	sus->J1p[1][0] = RF_in[18]; sus->J1p[1][1] = RF_in[19]; sus->J1p[1][2] = RF_in[20];
	sus->J1p[2][0] = RF_in[21]; sus->J1p[2][1] = RF_in[22]; sus->J1p[2][2] = RF_in[23];
